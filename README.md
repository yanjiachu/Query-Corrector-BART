...
### 与通用大模型对比
由于成本限制，我们选取了多个通用大模型在相同小样本示例测试集上进行对比（零样本提示）。
同时我们还尝试对Qwen2.5-1.5b-instruct进行了一个epoch的微调，效果稍好于BART-FT-epoch_1，但是略逊于BART-FT-epoch_3。
对比结果如下：
...
| BART-FT-epoch_1     | 0.069800 | 0.932849  | 0.930200 | 0.931162 |
| Qwen2.5-1.5b-SFT    | 0.068314 | 0.933762  | 0.931686 | 0.932359 |
